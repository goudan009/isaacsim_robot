...
class RuntimeVerifier(Node):
    def __init__(self, require_sensors: bool) -> None:
        ...
        self.last_livox_lidar: PointCloud2 | None = None
        ...
        self.create_subscription(PointCloud2, "/livox/lidar", self._livox_lidar_cb, qos_profile_sensor_data)
    ...
    def _livox_lidar_cb(self, msg: PointCloud2) -> None:
